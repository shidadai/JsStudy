...
let lunckyNumbers = [7, 15 , 23, 66, 91, 10, 13];
...
//Loop through an array has two wats, for loop and forEach function

lunckyNumbers.forEach((n)=>{
    if(n>20)
    console.log(n);
});


//anonymous function is atype of function declaration
